  ...
  function streamUrl(itemId, opts) {
    ...
    var postBody = {
      ...
      DeviceProfile: {
        ...
        DirectPlayProfiles: [
          { Container: 'hls', Type: 'Video', VideoCodec: 'h264,av1', AudioCodec: 'aac,mp3,mp2' },
          { Container: 'hls', Type: 'Video', VideoCodec: 'h264,av1', AudioCodec: 'aac,mp3,mp2' },
          ...
          { Container: 'hls', Type: 'Audio' },
          { Container: 'hls', Type: 'Video', VideoCodec: 'av1,h264', AudioCodec: 'aac,mp2' },
          { Container: 'hls', Type: 'Video', VideoCodec: 'h264', AudioCodec: 'aac,mp3,mp2' }
        ],
        TranscodingProfiles: [
          { Container: 'hls', Type: 'Audio', AudioCodec: 'aac', Context: 'Streaming', Protocol: 'hls', MaxAudioChannels: '6', MinSegments: '1', BreakOnNonKeyFrames: false, EnableAudioVbrEncoding: true },
          { Container: 'hls', Type: 'Audio', AudioCodec: 'aac', Context: 'Static', Protocol: 'hls', MaxAudioChannels: 6 },
